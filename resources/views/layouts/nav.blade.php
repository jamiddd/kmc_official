...
<ul id="dropdown-account-auth" class="dropdown-content">
    ...
    <li><a href="{{ route('logout') }}" style="text-transform:capitalize;" onclick="event.preventDefault();
        document.getElementById('logout-form').submit();" class="nav-link-bold-drop"
            tabindex="1">{{ __('Logout') }}</a></li>
...
<nav class="m-nav" style="z-index:4; transition:300ms;">
    <div class="nav-wrapper grey darken-4">
        ...
        <ul class="right hide-on-med-and-down">
            ...
            <li class="nav-link-bold">
                <a id="navbarDropdown" style="text-transform:capitalize;" class="nav-link-bold dropdown-trigger"
                    href="#!" data-target="dropdown-account-auth">
...
<ul id="slide-out" class="sidenav">
    ...
    @else
    <li>
        <div class="user-view" style="margin-bottom:0px !important;" onclick="window.location.href = '/home'">
    ...
    @endguest
    <li>
        <a class="waves-effect black-text center" style="background-color:#eeff41;"
    ...
    <li><a class="waves-effect" id="con" href="#footer-div">Contatc Us Here</a></li>
</ul>
...
<script>
    ...
    //         el.addClass('weird-nav'); 
    //     } else {
    //         el.removeClass('weird-nav');
    //     }
    // });
