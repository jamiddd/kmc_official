            ...
            <div id="s-div" class="side-div">
                <div class="card" style="padding:20px;">
                    ...
                    <div style="display:block;">
                        ...
                        <div style="display:block;" class="row">
                            <div class="chip blue white-text col offset-s5 offset-l5">
                                Admin
                            </div>
                        </div>
                        @endif
                ...
                <div style="margin: 20px 0px 0px 0px;">
                    <div id="tab1" class="card waves-effect"
                        ...
                        <span style="height:100%; padding-left:20px; line-height:56px; text-align:center;">Application
                            Requests
                            1</span>
                ...
                <div style="margin: 0px 0px 0px 0px;">
                    <div id="tab5" class="card waves-effect"
                        style="display:block; width:100%; height:56px; margin:0px !important; cursor:pointer;">
                        <span
                            style="height:100%; padding-left:20px; line-height:56px; color:red; text-align:center;">Log
                            out</span>
                        <div class="right" style="height:56px;">
