								...
								<div class="card-content">
										...
										<div class="row">
												{!!Form::open(['action' => 'ApplicationRequestController@store', 'method' => 'POST', 'files' => 'true'], ['class' => 'col s12'])!!}
													...
													<p>
														<label>
															<input type="checkbox" id="dbta" name="dbta" class="filled-in" />
															<span>By clicking here you accept the <b class="blue-text">Declaration by the Applicant</b> and the <b class="blue-text">Declaration by the Parents/Guardian.</b></span>
														</label>
														<a href="/" style="font-size:0.7rem;">Read More</a>
													</p>
													...
													<button id="applyBtn" class="white-text waves-effect waves-default pink btn no-padding" type="submit" style="width:100%; height:56px; line-height:56px; font-family: 'Montserrat', sans-serif; margin-top:30px;">Submit</button>
